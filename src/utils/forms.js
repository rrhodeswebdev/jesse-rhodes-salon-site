...
export const submitFormData = async (formData, formId, formCtx) => {
	...
	const body = {
		...
		legalConsentOptions: {
			legitimateInterest: {
				...
				legalBasis: 'LEAD',
				text:
					'Jesse Rhodes Salon needs the contact information you provide to us to contact you about our products and services. You may unsubscribe from these communications at any time.',
			},
		},
	};
